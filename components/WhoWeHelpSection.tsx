...
const WhoWeHelpSection: React.FC = () => {
  return (
    <section id="who-we-help" className="section bg-slate-800/50 py-16 sm:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <h2 className="text-base font-semibold text-[#00D1FF] tracking-wide uppercase">Who We Work With</h2>
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {industries.map((industry, idx) => (
            <div
              key={idx}
              className="flex items-start space-x-4 p-6 rounded-lg border border-[#30363D] bg-[#161B22] hover:border-[#00D1FF] transition-all duration-300 group"
            >
              <div className="text-[#00D1FF] flex-shrink-0 group-hover:scale-110 transition-transform">
                {industry.icon}
              </div>
              <div>
                <h3 className="text-lg font-bold text-[#E6EDF3] mb-1">{industry.title}</h3>
                <p className="text-[#8B949E] text-sm">{industry.description}</p>
              </div>
            </div>
          ))}
        </div>
